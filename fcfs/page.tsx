...
export default function FCFS() {
  ...
  return (
    <section className="min-h-screen py-20 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-green-50 via-white to-[var(--color-primary-50)]">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-gray-800">Create Processes</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6 sm:mb-8">
            ...
            >
              ...
              <span className="text-sm sm:text-base">Add Process</span>
            </motion.button>
          </div>

          <div className="space-y-2 sm:space-y-3 mb-6 sm:mb-8">
            {processes.length === 0 ? (
              <p className="text-center text-gray-500 py-6 sm:py-8 text-sm sm:text-base">No processes yet. Add one above.</p>
            ) : (
              processes.map((p) => (
                <motion.div
                  key={p.id}
                ...
                >
                  <div className="flex items-center gap-3 sm:gap-8 font-semibold text-sm sm:text-base">
                    ...
                    <span>AT: <strong className="text-[var(--color-primary-700)]">{p.at}</strong></span>
        ...
        {result && (
          <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} className="space-y-8 sm:space-y-10 lg:space-y-12">
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl p-5 sm:p-8 lg:p-10">
              <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center mb-6 sm:mb-8 lg:mb-10 text-gray-800">Execution Timeline</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10">
              ...
              <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl p-5 sm:p-6 lg:p-8 overflow-x-auto">
                <h3 className="text-2xl sm:text-3xl font-bold text-center mb-4 sm:mb-6 text-gray-800">Process Table</h3>
                <table className="w-full border-collapse text-sm sm:text-base lg:text-lg">
                  <thead>
                    <tr className="bg-gradient-to-r from-green-600 to-[var(--color-primary-600)] text-white">
              ...
              >
                <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-6 sm:mb-8 lg:mb-10">Averages</h3>
